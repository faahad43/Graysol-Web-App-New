...
const Testimonial = () => {
  ...
  return (
    <section className='testimonial bg-dark-900 py-12 px-2' id='skills'>
        ...
        <div className='row'>
          <div className='col-12'>
            <div className='testimonial-bx'>
              ...
              <p className={`${styles.subHeadingText} my-8`}>
              ...
              >
                <div className='w-11/12 testimonial-slider-item'>
                  <div class='card p-4 text-center px-6 bg-light-900 rounded-lg'>
                ...
                <div className='w-11/12 testimonial-slider-item'>
                  <div class='card p-4 text-center px-6 bg-light-900 rounded-lg'>
                    <div class='user-content'>
                      ...
                      <h3 class='mb-0 mt-2'>Leonardo Turchi</h3>
                      <span className='text-gray-500 text-[14px]'>
                ...
                <div className='w-11/12 testimonial-slider-item'>
                  <div class='card p-4 text-center px-6 bg-light-900 rounded-lg'>
                    <div class='user-content'>
                      ...
                      <h3 class='mb-0 mt-2'>Ionut John Panait</h3>
                      <span className='text-gray-500 text-[14px]'>
                        Businessman, Romania
                      </span>
                      <div className='flex flex-wrap justify-center mt-2'>
