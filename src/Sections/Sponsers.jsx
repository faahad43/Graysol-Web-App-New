...
const Sponsers = () => {
  return (
    <div className='w-screen relative grid bg-dark-100 grid-cols-3 lg:grid-cols-6 py-6 lg:py-8 xl:py-10 place-items-center lg:px-[10%] gap-5 before:absolute before:inset-0 before:bg-dark-200 before:opacity-20'>
