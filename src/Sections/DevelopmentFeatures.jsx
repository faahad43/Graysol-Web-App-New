...
const cardStyles = {
    cardStyling :'text-light-900 bg-dark-900 h-56 md:h-80 lg:h-96 p-3 sm:gap-8 md:gap-4 lg:gap-8 sm:px-[12%] md:px-3 md:flex-col lg:p-12',
...
const data = [
    ...
    {
        img:Feature5,
        imgStyle:'w-[55px] h-[62px] md:w-[60px] md:h-[60px] lg:w-[70px] lg:h-[70px]',
        heading: pageType.developmentFeature[4].title,
        description: pageType.developmentFeature[4].description,
    },
    {
        img:Feature6,
        imgStyle:'w-[56px] h-[60px] md:w-[60px] md:h-[60px] lg:w-[70px] lg:h-[70px]',
  ...
  return (
    <div className='bg-dark-900 py-16 text-center space-y-8'>
        ...
        <div 
            className='bg-light-900 max-w-[1267px] w-[90%] rounded-3xl mx-auto md:place-items-center grid grid-cols-1 md:grid-cols-3 gap-y-5 md:gap-x-4 lg:gap-x-12 p-7 sm:px-12 md:px-5 lg:p-12'
        >
            {data.map((item,index)=> (
