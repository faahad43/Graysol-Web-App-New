...
const Question = () => {
  return (
    <div className='bg-dark-900 w-screen flex flex-col items-center justify-center py-8 lg:py-20 gap-10 lg:gap-20'>
        <div className='w-[90%] sm:w-[80%] max-w-[1138px] bg-primary-700 rounded flex flex-col items-center justify-center py-5 lg:py-8 px-5 text-center text-light-900 gap-3 rounded-xl'>
           <div>
            ...
            <div className='flex flex-col md:flex-row md:justify-around items-center w-full gap-2 md:gap-0 '>
                <Input className='w-11/12 md:w-5/12' placeholder='Your Name'/>
                <Input className='w-11/12 md:w-5/12' placeholder='Your Email'/>
            </div>
