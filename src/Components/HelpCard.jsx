...
const HelpCard = ({page,title,description,index}) => {
  ...
  return (
    <div className={`${page === "Home"? 'h-[12.3rem] lg:h-[14rem] xl:h-[20rem] lg:pt-8' :''} relative bg-light-900 w-[17rem] lg:w-[22rem] xl:w-[26rem]  rounded-sm text-dark-900 pl-8 xl:pl-10 pr-4 xl:pr-6 pt-5`}>
