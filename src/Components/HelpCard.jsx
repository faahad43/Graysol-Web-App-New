...
const HelpCard = ({page,title,description,index}) => {
  ...
  return (
    <div className={`${page === "Home"? 'h-[15rem] md:h-[16rem] lg:h-[18rem] xl:h-[20rem] lg:pt-8' :'h-[11rem] md:h-[13rem] lg:h-[15rem] xl:h-[16rem]'} relative bg-light-900 w-[17rem] lg:w-[22rem] xl:w-[26rem]  rounded-sm text-dark-900 pl-8 xl:pl-10 pr-4 xl:pr-6 pt-5`}>
