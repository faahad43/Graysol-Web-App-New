...
const BlogCard = () => {
  return (
    <div className='space-y-3 text-light-900'>
      <div className='space-y-2'>
        <img className='rounded-xl' src={BlogCardImage} alt="" />
        <p className='pl-2 uppercase text-[15px] md:text-[18px] text-center'>1 min</p>
      </div>
      <div className='pl-2 w-[100%] md:w-[85%] space-y-8'>
        <p className='text-[14px] font-light capitalize tracking-wider text-center'>
          Walker Mattox, CEO of Gray Solutions, on Building a Dynamic Team of Solutioneers
        </p>
        <div className='flex gap-3 justify-center text-light text-[12px] tracking-wider'>
